...
<head>
    ...
    <script language="JavaScript" src="js/m_vessel.js"></script>
...
<!--            <th>Vehicle Number</th>-->
        ...
        <tbody>
        <?php
        $sql = "SELECT * from m_vessel where cancel =0";
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr>                
                              ...
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['company_ref'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['name'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['flag'] . "</a></td>
                             </tr>";
        }
        ?>
    </table>
