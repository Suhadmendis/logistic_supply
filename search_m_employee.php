...
<head>
    ...
    <script language="JavaScript" src="js/m_employee.js"></script>
...
<div id="filt_table" class="CSSTableGenerator container">
    <table id='example'  class='table table-bordered'>
        ...
        <tbody>
        <?php
        $sql = "SELECT * from m_employee where cancel =0";
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr>                
                              ...
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['designation_ref'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['name'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['nic'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['vehicle_number'] . "</a></td>
                             </tr>";
        }
        ?>
    </table>
