var vue = new Vue({
    ...
    mounted () {
        axios
            .get('m_company_data.php?Command=generate')
            .then(response => {
...
function getFromValues()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById('fax').value = objSup.fax;
            opener.document.getElementById('web').value = objSup.web;
        ...
        if (IDF === "item") {
            opener.document.getElementById('company_ref').value = objSup.REF;
            opener.document.getElementById('company_name').value = objSup.name;
        }
