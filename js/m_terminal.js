var vue = new Vue({
    ...
    mounted () {
        axios
            .get('m_terminal_data.php?Command=generate')
            .then(response => {
...
function getFromValues()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (IDF === "item") {
            opener.document.getElementById('terminal_ref').value = objSup.REF;
            opener.document.getElementById('terminal_name').value = objSup.nme;
        }
