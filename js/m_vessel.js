var vue = new Vue({
    ...
    mounted () {
        axios
            .get('m_vessel_data.php?Command=generate')
            .then(response => {
...
function save_info()
{
    ...
    var url = "m_vessel_data.php";
    url = url + "?Command=" + "save_item";
    url = url + "&REF=" + document.getElementById("REF").value;
    url = url + "&name=" + document.getElementById("name").value;
    url = url + "&company_ref=" + document.getElementById("company_ref").value;
    url = url + "&flag=" + document.getElementById("flag").value;
    url = url + "&imo_number=" + document.getElementById("imo_number").value;
    url = url + "&call_sign=" + document.getElementById("call_sign").value;
...
function getFromValues()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById('company_ref').value = objSup.company_ref;
            opener.document.getElementById("company_name").value = objSup.company_name;
            opener.document.getElementById('name').value = objSup.name;
            opener.document.getElementById('flag').value = objSup.flag;
            opener.document.getElementById('imo_number').value = objSup.imo_number;
            opener.document.getElementById('call_sign').value = objSup.call_sign;
        ...
        if (IDF === "item") {
            opener.document.getElementById('vessel_ref').value = objSup.REF;
            opener.document.getElementById('vessel_name').value = objSup.vessel_name;
        }
