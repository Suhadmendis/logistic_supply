var vue = new Vue({
    ...
    mounted () {
        axios
            .get('m_designation_data.php?Command=generate')
            .then(response => {
...
function save_info()
{
    ...
    var url = "m_designation_data.php";
...
function getFromValues()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById('designation').value = objSup.designation;
        ...
        if (IDF === "item") {
            opener.document.getElementById('designation_ref').value = objSup.REF;
            opener.document.getElementById('designation_name').value = objSup.designation;
        }
